...
<script>
	$(document).ready(function(){
		$('input[type="button"]').click(function(){
				...
				$('#r_form').attr('action','user.do?cmd=addimpl'); // cmd를 add라고 하면 add 페이지로 가므로 addimpl이라고 새로 붙임
				$('#r_form').submit();
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="val-userid"
											name="val-userid" placeholder="Enter a user id..">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="val-username"
											name="val-username" placeholder="Enter a user name..">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="password" class="form-control" id="val-password"
											name="val-password" placeholder="Enter a user password..">
									</div>
								</div>
