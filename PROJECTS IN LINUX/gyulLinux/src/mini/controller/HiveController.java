...
public class HiveController {
	...
	public ModelAndView chart(ModelAndView mv,HttpServletResponse response) throws Exception{
		...
		while (rs2.next()) {
			for(int i=1; i<2; i++) {
			 ...
			 data2 = new JSONObject();
				 ...
				 */
			 data2.put("name",rs2.getString(1));
			 data2.put("y",rs2.getFloat(2));	
		...
		out.print(prolist2.toJSONString());
		out.close();
