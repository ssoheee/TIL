...
<script>
	function btn(val){
		...
		if (val=="addcart"){
			form.action="addcart.mc";
			alert('Added to Cart!');
		} else if (val=="order"){
			form.action="dorder.mc";
		}
		form.submit();
	}
</script>
						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3"
									data-thumb="images/${productdetail.product_picture1 }">
									<div class="wrap-pic-w pos-relative">
										<img src="images/${productdetail.product_picture1 }"
											alt="IMG-PRODUCT"> <a
											class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
											href="images/${productdetail.product_picture1 }"> <i
								...
								<div class="item-slick3"
									data-thumb="images/${productdetail.product_picture2 }">
									<div class="wrap-pic-w pos-relative">
										<img src="images/${productdetail.product_picture2 }"
											alt="IMG-PRODUCT"> <a
											class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
											href="images/${productdetail.product_picture2 }"> <i
											class="fa fa-expand"></i>
										</a>
									</div>
								</div>
								...
								<div class="item-slick3"
									data-thumb="images/${productdetail.product_picture3 }">
									<div class="wrap-pic-w pos-relative">
										<img src="images/${productdetail.product_picture3 }"
											alt="IMG-PRODUCT"> <a
											class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
											href="images/${productdetail.product_picture3 }"> <i
											class="fa fa-expand"></i>
										</a>
									</div>
								</div>
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						<h4 class="mtext-105 cl2 js-name-detail p-b-14">
							${productdetail.product_no }</h4>

						<span class="mtext-106 cl2"> ${productdetail.product_price }
						</span>

						<p class="stext-102 cl3 p-t-23">${productdetail.farm_nm }에서만든
							당도 높은 ${productdetail.product_nm }</p>
						...
						<form name="thisform" method="post">
							<div class="flex-w flex-r-m p-b-10">
								<input class="size-111 bor8 stext-102 cl2 p-lr-20" id="pro_no"
								...
								<div class="size-204 flex-w flex-m respon6-next">
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<input class="mtext-104 cl3 txt-center num-product"
											type="number" id="pro_qt" name="pro_qt" value="1">
									...
									<input type="button"
										...
										value="Add to Cart" id="addcart" onclick="btn('addcart');"> 
										
										<input type="button"
										class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10"
										value="Order" id="order" onclick="btn('order');">
								</div>
						</form>
					</div>
				</div>
			...
			<div class="tab01">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item p-b-10"><a class="nav-link"
						data-toggle="tab" href="#information" role="tab">농장 설명</a></li>

					<li class="nav-item p-b-10"><a class="nav-link"
						data-toggle="tab" href="#reviews" role="tab">리뷰 (게시판)</a></li>
				</ul>
