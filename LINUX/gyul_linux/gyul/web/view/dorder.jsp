				...
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					...
					<div class="col-sm-6 p-b-5 m-lr-auto">
						...
						<div>
							<table>
								<tr class="table_row">
									<td class="column-1"><img class="how-itemcart1" src="images/${dorder.product_picture1 }" 
										alt="IMG"></td>
					...
					<label class="stext-102 cl3"></label> <input type="button"
						value="ORDER" onClick="location.href='orderdetail.html'"
